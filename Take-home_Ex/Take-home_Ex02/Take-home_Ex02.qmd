...
## 3.1 Makeover 1: **Distribution of Students’ Performance**
...
| [**Clarity**]{.underline}                                                                                                                                                                                                                                                                                                                                                                                                               |
|                                                                                                                                                                                                                                                                                                                                                                                                                                         |
| a.  💚 Axes labeling is generally neat and clear, with similar x-axis and y-axis limits across the 3 plots. A small improvement can be achieved in rotating the y-axis label so that it is more readable.                                                                                                                                                                                                                               |
| b.  💚 Use of annotation and different colours to indicate the values of mean and median is clear.                                                                                                                                                                                                                                                                                                                                      |
| c.  ❌ Title of the plot can include an overview of key insights generated from the plot, rather than just showing the conventional description of the plot. A subtitle can also be used to provide more details on the insights. The original submission did not make use of a subtitle.                                                                                                                                               |
| d.  ❌ The distributions of the 3 domains are in separate plots on different tabs, as such, this makes any comparisons difficult.                                                                                                                                                                                                                                                                                                       |
| e.  ❌ The addition of geom_vlines for the mean and median values on a histogram may be confusing, that is, it does provide any further insights apart from comparing the values across the 3 plots, which can be better achieved if they were combined and stacked in a single plot. To similarly indicate these values on the plot, a better approach will be to use a box plot, which can provide more quantile values for analysis. |
+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| [**Aesthetics**]{.underline}                                                                                                                                                                                                                                                                                                                                                                                                            |
|                                                                                                                                                                                                                                                                                                                                                                                                                                         |
| a.  💚 Title position on the chart is aligned.                                                                                                                                                                                                                                                                                                                                                                                          |
| b.  💚 Use of different "soft" colours for different domains on different plots helps to make the plots less dull.                                                                                                                                                                                                                                                                                                                      |
| c.  ❌ There seemed to be too much gridlines on the chart, which makes the chart area a bit busy. It would be better to use a theme that uses less gridlines.                                                                                                                                                                                                                                                                           |
| d.  ❌ Both the mean and median lines, though in dashed '-' lines, are in darker colors than the plot, which may give an impression that the focus is on the 2 statistic values.                                                                                                                                                                                                                                                        |
+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
...
| [**Clarity**]{.underline}                                                                                                                                                                                                                                   |
|                                                                                                                                                                                                                                                             |
| a.  💚 Placing the plots for the 3 domains one on top of the other is good, as it helps the viewer to make visual comparisons.                                                                                                                              |
| b.  ❌ However, stacking the 2 density distributions for the 2 genders together on the same grid makes the plot difficult to read, as the 2 distributions are very similar and nearly overlap each other. A better plot would be to use the ridgeline plot. |
| c.  ❌ Does not have a title and subtitle to provide context and/or insights derived from the visualisation.                                                                                                                                                |
| d.  ❌ The y-axis of the 3 plots are in different ranges, hence making them more difficult to be compared visually.                                                                                                                                         |
+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| [**Aesthetics**]{.underline}                                                                                                                                                                                                                                |
|                                                                                                                                                                                                                                                             |
| a.  💚 Overall, the plot is neat and the information is shown in clear fonts and font sizes.                                                                                                                                                                |
| b.  💚 Use of different "soft" colours for different genders helps to make the plots less dull.                                                                                                                                                             |
| c.  ❌ There seemed to be too much gridlines on the chart, which makes the chart area a bit busy. It would be better to use a theme that uses less gridlines. In this case, gridlines are more or less redundant.                                           |
| d.  ❌ The same legend is repeated 3 times, which is redundant.                                                                                                                                                                                             |
+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
...
| [**Clarity**]{.underline}                                                                                                                                                 |
|                                                                                                                                                                           |
| a.  💚 Individually, both the box plot and the density distribution of the Math score by school type are clear in showing the data.                                       |
| b.  ❌ However, they 2 plots are plotted separately. A better plot would be one where the boxplot is placed below each density curve, such as that of the raincloud plot. |
| c.  ❌ Does not have a title and subtitle to provide context and/or insights derived from the visualisation.                                                              |
| d.  ❌ The axes of the 2 plots are switched, hence making them more difficult to be compared visually.                                                                    |
+---------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| [**Aesthetics**]{.underline}                                                                                                                                              |
|                                                                                                                                                                           |
| a.  💚 Overall, the individual plots are neat and the information is shown in clear fonts and font sizes.                                                                 |
| b.  ❌ x-axis ticks on the boxplot is redundant since x is a categorical variable.                                                                                        |
| c.  ❌ The colours used in both plots are different, though there is not much reason for them to be different since both plots are referirng to the school type.          |
| d.  ❌ y-axis titles can be flipped for better readability.                                                                                                               |
+---------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
...
| [**Clarity**]{.underline}                                                                                                                                                |
|                                                                                                                                                                          |
| a.  💚 Individually, both the box plot and the density distribution of the Math score by socioeconomic status are clear in showing the data.                             |
| b.  ❌ However, they 2 plots are plotted separately. A better plot would be one where the boxplot is placed below the density curve, such as that of the raincloud plot. |
| c.  ❌ Does not have a title and subtitle to provide context and/or insights derived from the visualisation.                                                             |
| d.  ❌ The axes of the 2 plots are switched, hence making them more difficult to be compared visually.                                                                   |
+--------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| [**Aesthetics**]{.underline}                                                                                                                                             |
...
| c.  ❌ The colours used in both plots are different, though there is not much reason for them to be different since both plots are referirng to the school type.         |
| d.  ❌ y-axis titles can be flipped for better readability.                                                                                                              |
| e.  ❌ Use of different themes for both plots makes the overall look and feel somewhat disjointed.                                                                       |
+--------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
