...
### 1.1 **Installing and loading the required libraries** {style="color: white"}
...
### 1.2 **Importing data** {style="color: white"}
...
## **2. Beyond ggplot2 Annotation: ggrepel** {style="color: yellow"}
...
### **2.1 Working with ggrepel** {style="color: white"}
...
## **3. Beyond ggplot2 Themes** {style="color: yellow"}
...
### **3.1 Working with ggtheme package** {style="color: white"}
...
### **3.2 Working with hrbthems package** {style="color: white"}
...
## **4 Beyond Single Graph** {style="color: yellow"}
...
### **4.1 Creating Composite Graphics: pathwork methods** ![](https://r4va.netlify.app/chap02/img/image4.png){width="32" height="38"} {style="color: white"}
...
### **4.2 Combining two ggplot2 graphs** {style="color: white"}
...
### **4.3 Combining three ggplot2 graphs** {style="color: white"}
...
### **4.4 Creating a composite figure with tag** {style="color: white"}
...
### 4.5 **Creating figure with insert** {style="color: white"}
...
### **4.6 Creating a composite figure by using patchwork and ggtheme** {style="color: white"}
