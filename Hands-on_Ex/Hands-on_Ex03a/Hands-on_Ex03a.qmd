...
In this section,  [*read_csv()*](https://readr.tidyverse.org/reference/read_delim.html) of **readr** package was used to import the provided dataset, *Exam_data.csv,* into R.
...
[ggiraph](https://davidgohel.github.io/ggiraph/) ![](https://r4va.netlify.app/chap03/img/image1.jpg){width="26"} is an htmlwidget and a ggplot2 extension. It allows ggplot graphics to be interactive.
...
crosstalk::bscols(gg,
                  DT::datatable(d, style = "bootstrap"),
                  widths = 5)
```
